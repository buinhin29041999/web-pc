...
public class ProductDAO extends AbstractDAO<ProductModel> implements IProductDAO {
	...
	public List<ProductModel> findAllOrSearch(String type, Long categoryid, String name, Long brandId) {
		...
		else if (type.equals("FindByBrand")) {
			sql.append("select * from Product where brandId= "+ brandId);
		}
	...
	public void update(ProductModel sp) {
		...
		update(sql.toString(), sp.getName(), sp.getCategoryId(), sp.getBrandId(), sp.getShortDescription(),
				sp.getImage(), sp.getContent(), sp.getPrice(), sp.getAmount(), sp.getCreatedDate(), sp.getCreatedBy(),
				sp.getModifiedDate(), sp.getModifiedBy(), sp.getId());
