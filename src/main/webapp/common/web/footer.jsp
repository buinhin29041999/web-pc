				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="footer">
						...
						<ul class="footer-social">
							<li><a href="https://www.facebook.com/phuong.hoangngoc.792197"><i class="fab fa-facebook-f"></i></a></li>
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center">
					...
					<div class="footer-copyright">
						...
						</script> Cảm ơn bạn đã ghé thăm trang web!</br> <i class="far fa-heart"></i> by Hoàng Phương
					</div>
					<!-- /footer copyright -->
				</div>
			</div>
